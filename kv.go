...
//
// For more details on how they differ, please read the explanations for each method or the protocol page: https://github.com/domgolonka/docs/blob/main/freedb/protocols.md.
